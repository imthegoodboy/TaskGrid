...
export default function Home() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Get paid in USDC or MATIC instantly. Zero withdrawal delays, minimal gas fees.",
    },
    {
      icon: Globe,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
          <div className="text-center space-y-8">
            ...
            <p className="text-lg sm:text-xl text-gray-200 max-w-3xl mx-auto" data-testid="text-hero-subtitle">
              A Web3 freelance marketplace with built-in trust, escrow, and proof-of-work NFTs—powered by Polygon blockchain. Zero fees, instant payments, verified reputation.
            </p>
